...
/**
 * @file
 * Definition of Drupal\customviews\Plugin\views\field\TermExport
 */
...
/**
 * Field handler for term export
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("term_export")
 */
class TermExport extends FieldPluginBase {
